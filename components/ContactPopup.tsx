	...
	return (
		<>
			<div className="contact--popup--wrapper">
				<div className="contact--pop-inner">
						...
						<div className="pop--header">
							...
							<div className="pop-close">
								<svg xmlns="http://www.w3.org/2000/svg" width={27} height={24} viewBox="0 0 27 24"
									fill="none">
									<path
										d="M16.0883 12.0172L26.9492 24H21.7218L13.2462 14.6341L5.17669 24H0.0507521L10.8609 12.0172L0 0H5.17669L13.703 9.40029L21.8233 0H27L16.0883 12.0172Z"
										fill="white" />
								</svg>
							</div>
						</div>
						<h3>Share what you need<br /> from us.</h3>


						<div className="wpcf7 no-js" id="wpcf7-f302-o1" lang="en-US" dir="ltr" data-wpcf7-id="302">
							<div className="screen-reader-response"><p role="status" aria-live="polite" aria-atomic="true"></p> <ul></ul></div>
							<form action="https://softvence.agency/#wpcf7-f302-o1" method="post" className="wpcf7-form init" aria-label="Contact form" noValidate data-status="init">
								<fieldset className="hidden-fields-container"><input type="hidden" name="_wpcf7" defaultValue="302" /><input type="hidden" name="_wpcf7_version" defaultValue="6.1.4" /><input type="hidden" name="_wpcf7_locale" defaultValue="en_US" /><input type="hidden" name="_wpcf7_unit_tag" defaultValue="wpcf7-f302-o1" /><input type="hidden" name="_wpcf7_container_post" defaultValue="0" /><input type="hidden" name="_wpcf7_posted_data_hash" defaultValue="" />
								</fieldset>
								<div className="row align-items-end">
									<div className="col-md-6 mt_20">
										<div className="input--group">
											<span className="wpcf7-form-control-wrap" data-name="text-710"><input size={40} maxLength={400} className="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required aria-invalid="false" placeholder="Your Name" defaultValue="" type="text" name="text-710" /></span>
										</div>
										<div className="input--group">
											<span className="wpcf7-form-control-wrap" data-name="email-377"><input size={40} maxLength={400} className="wpcf7-form-control wpcf7-email wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-email" aria-required aria-invalid="false" placeholder="Your Email" defaultValue="" type="email" name="email-377" /></span>
										</div>
										<div className="input--group">
											<span className="wpcf7-form-control-wrap" data-name="textarea-849"><textarea cols={40} rows={10} maxLength={2000} className="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required" aria-required aria-invalid="false" placeholder="Tell Us About Your Project" name="textarea-849"></textarea></span>
										</div>
									</div>
									<div className="col-md-6 mt_20">
										<div className="pop--tags--box">
											...
											<ul>
												<li className="pop--interest--group">
													<span className="wpcf7-form-control-wrap" data-name="checkbox-199"><span className="wpcf7-form-control wpcf7-checkbox"><span className="wpcf7-list-item first"><label><input type="checkbox" name="checkbox-199[]" value="Accounting and Bookkeeping" /><span className="wpcf7-list-item-label">Accounting and Bookkeeping</span></label></span><span className="wpcf7-list-item"><label><input type="checkbox" name="checkbox-199[]" value="Data Analytics" /><span className="wpcf7-list-item-label">Data Analytics</span></label></span><span className="wpcf7-list-item"><label><input type="checkbox" name="checkbox-199[]" value="Branding" /><span className="wpcf7-list-item-label">Branding</span></label></span><span className="wpcf7-list-item"><label><input type="checkbox" name="checkbox-199[]" value="UI/UX Desgin" /><span className="wpcf7-list-item-label">UI/UX Desgin</span></label></span><span className="wpcf7-list-item"><label><input type="checkbox" name="checkbox-199[]" value="Web Development" /><span className="wpcf7-list-item-label">Web Development</span></label></span><span className="wpcf7-list-item"><label><input type="checkbox" name="checkbox-199[]" value="Mobile App" /><span className="wpcf7-list-item-label">Mobile App</span></label></span><span className="wpcf7-list-item last"><label><input type="checkbox" name="checkbox-199[]" value="Consultation" /><span className="wpcf7-list-item-label">Consultation</span></label></span></span></span>
												</li>

											</ul>
										</div>
										<div className="input--group">
											<span className="wpcf7-form-control-wrap" data-name="budget"><select className="wpcf7-form-control wpcf7-select" id="budget" aria-invalid="false" name="budget"><option value="Select your Budget (USD)">Select your Budget (USD)</option><option value="500$-5000$">500$-5000$</option><option value="5000$-15000$">5000$-15000$</option><option value="15000$-25000$">15000$-25000$</option><option value="25000$-35000$">25000$-35000$</option><option value="35000$-55000$">35000$-55000$</option><option value="55000$-75000$">55000$-75000$</option><option value="More">More</option></select></span>
										</div>
									</div>
									<div className="btn--area text-center">
										<input className="wpcf7-form-control wpcf7-submit has-spinner button" type="submit" value="Submit" />
									</div>
