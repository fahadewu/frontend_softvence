...
export default function WorkListClient({ initialCaseStudies }: WorkListClientProps) {
            ...
            if (typeof window !== 'undefined' && gridRef.current) {
                if ((window as any).Isotope) {
                    ...
                    isotopeRef.current = {
                        ...
                        layout: () => $(gridRef.current).isotope('layout')
                    }
                }
            }
        };
                                ...
                                <div className="col-md-12">
                                    <div className="case--studies--wrapper">
                                        <div className="filters filter-button-group">
                                            <ul>
                                                <li className={filterKey === '*' ? 'active button-click' : 'button-click'} onClick={() => handleFilterChange('*')}>All</li>
                                                <li className={filterKey === '.branding' ? 'active button-click' : 'button-click'} onClick={() => handleFilterChange('.branding')}>Branding</li>
                                                <li className={filterKey === '.mobile-app' ? 'active button-click' : 'button-click'} onClick={() => handleFilterChange('.mobile-app')}>Mobile App</li>
                                                <li className={filterKey === '.ui-ux' ? 'active button-click' : 'button-click'} onClick={() => handleFilterChange('.ui-ux')}>UI/UX Design</li>
                                                <li className={filterKey === '.vibe-coding' ? 'active button-click' : 'button-click'} onClick={() => handleFilterChange('.vibe-coding')}>Vibe Coding</li>
                                                <li className={filterKey === '.web-develop' ? 'active button-click' : 'button-click'} onClick={() => handleFilterChange('.web-develop')}>Web Development</li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className="row grid case-gallery" ref={gridRef}>
                                            {initialCaseStudies.length > 0 ? (
                                                initialCaseStudies.map((caseStudy) => (
                                                    <div key={caseStudy.slug} className={`col-md-6 mt_85 ${caseStudy.categories.join(' ')}`}>
