...
export default function BlogListClient({ initialPosts }: BlogListClientProps) {
    ...
    const categories = Array.from(new Set(initialPosts.map(post => post.category).filter(Boolean)));
                        ...
                        <div className="container">
                            ...
                            <div className="row" data-aos="fade-up" data-aos-duration="1000">
                                <div className="col-md-12">
                                    ...
                                    <div className="case--studies--wrapper">
                                        ...
                                        <div className="filters filter-button-group">
                                            <ul>
                                                <li
                                                    className={`button-click ${filter === '*' ? 'active' : ''}`}
                                                ...
                                                {categories.map((category) => (
                                                    <li
                                                        key={category}
                                                        className={`button-click ${filter === category ? 'active' : ''}`}
                                        ...
                                        <div className="row case-gallery">
                                            {filteredPosts.length > 0 ? (
                                                filteredPosts.map((post: any) => (
                                                    <div key={post.slug} className="col-lg-4 col-md-6 mt_80 webdesign">
                                ...
                                <ul className="pagination--wrapper" data-aos="fade-In" data-aos-duration="1000">
                                    ...
                                    <li><a href="#">3</a></li>
                                    <li><a href="#">4</a></li>
                                    <li><a href="#" className="page--dots">..............</a></li>
                                    <li><a href="#">20</a></li>
                                </ul>
                            </div>
                        </div>
