				...
				<main>
					...
					<section className="about--image--area">
						<div className="about--image--wrapper">
							<img src="https://softvence.agency/wp-content/uploads/2024/03/Thumnail-3.png?bv_host=softvence.agency&amp;bv-resized-infos=bv_resized_mobile%3A480%2A446%3Bbv_resized_ipad%3A820%2A762%3Bbv_resized_desktop%3A826%2A768" loading="lazy" className="w-100 bv-tag-attr-replace bv-lazyload-tag-img" alt="" />
						</div>
					</section>
							...
							<div className="choose--cards--wrapper">
								...
								<div className="choose--card" data-aos="fade-up" data-aos-duration="1000">
									...
									<div className="hover--revel--img">
										<img bv-data-src="https://softvence.agency/wp-content/uploads/2024/02/case-studies1.png?bv_host=softvence.agency&amp;bv-resized-infos=bv_resized_mobile%3A480%2A360%3Bbv_resized_ipad%3A820%2A615%3Bbv_resized_desktop%3A1024%2A768" className="bv-tag-attr-replace bv-lazyload-tag-img" loading="lazy" src="https://softvence.agency/wp-content/uploads/2024/02/case-studies1.png" alt="" />
									</div>
								</div>
								<div className="choose--card" data-aos="fade-up" data-aos-duration="1000">
									...
									<div className="hover--revel--img">
										<img bv-data-src="https://softvence.agency/wp-content/uploads/2024/02/blog1.png?bv_host=softvence.agency&amp;bv-resized-infos=bv_resized_mobile%3A427%2A357%3Bbv_resized_ipad%3A427%2A357%3Bbv_resized_desktop%3A427%2A357" className="bv-tag-attr-replace bv-lazyload-tag-img" loading="lazy" src="https://softvence.agency/wp-content/uploads/2024/02/blog1.png" alt="" />
									</div>
								</div>
								<div className="choose--card" data-aos="fade-up" data-aos-duration="1000">
									...
									<div className="hover--revel--img">
										<img bv-data-src="https://softvence.agency/wp-content/uploads/2024/02/team2.png?bv_host=softvence.agency&amp;bv-resized-infos=bv_resized_mobile%3A359%2A443%3Bbv_resized_ipad%3A359%2A443%3Bbv_resized_desktop%3A359%2A443" className="bv-tag-attr-replace bv-lazyload-tag-img" loading="lazy" src="https://softvence.agency/wp-content/uploads/2024/02/team2.png" alt="" />
									</div>
								</div>
								<div className="choose--card" data-aos="fade-up" data-aos-duration="1000">
								...
								<div className="choose--card" data-aos="fade-up" data-aos-duration="1000">
									...
									<div className="hover--revel--img">
										<img bv-data-src="https://softvence.agency/wp-content/uploads/2024/02/image-57.png?bv_host=softvence.agency&amp;bv-resized-infos=bv_resized_mobile%3A480%2A755%3Bbv_resized_ipad%3A538%2A846%3Bbv_resized_desktop%3A538%2A846" className="bv-tag-attr-replace bv-lazyload-tag-img" loading="lazy" src="https://softvence.agency/wp-content/uploads/2024/02/image-57.png" alt="" />
									</div>
								</div>
							</div>
						</div>
							...
							<div className="owl-carousel team--slider" data-aos="fade-In" data-aos-duration="1000">
								<div className="item">
									<div className="team--box img--small">
										<img bv-data-src="https://softvence.agency/wp-content/uploads/2024/02/team1.png?bv_host=softvence.agency&amp;bv-resized-infos=bv_resized_mobile%3A464%2A544%3Bbv_resized_ipad%3A464%2A544%3Bbv_resized_desktop%3A464%2A544" className="bv-tag-attr-replace bv-lazyload-tag-img" loading="lazy" src="https://softvence.agency/wp-content/uploads/2024/02/team1.png" alt="" />
									</div>
								</div>
								<div className="item">
